...
export default function FrameBox({ backgroundSrc, children, className, padding = {}, style, ...rest }) {
  return (
    <div {...rest} className={[styles.frameBox, className].filter(Boolean).join(" ")} style={style}>
      <div aria-hidden="true" className={styles.frameBackground} style={backgroundSrc ? { backgroundImage: `url(${backgroundSrc})` } : undefined} />
      <div
        className={styles.frameContent}
        style={{
          paddingTop: padding.top ? "var(--spacing-spacious-medium)" : 0,
          paddingBottom: padding.bottom ? "var(--spacing-spacious-medium)" : 0,
          paddingLeft: padding.left ? "var(--spacing-spacious-medium)" : 0,
          paddingRight: padding.right ? "var(--spacing-spacious-medium)" : 0,
          ...
          "--frame-radius-tl": padding.top && padding.left ? "var(--radius-medium)" : "0",
          "--frame-radius-tr": padding.top && padding.right ? "var(--radius-medium)" : "0",
          "--frame-radius-bl": padding.bottom && padding.left ? "var(--radius-medium)" : "0",
          "--frame-radius-br": padding.bottom && padding.right ? "var(--radius-medium)" : "0",
        }}
      >
        {children}
      </div>
